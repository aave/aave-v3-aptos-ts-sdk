...
export class FPMath {
  ...
  static ZERO = new FixedPointNumber(0n, 0n);

  static ONE = new FixedPointNumber(1n, 0n);

  static MINUS_ONE = new FixedPointNumber(-1n, 0n);
  ...
  static toFP(value: Numberish, _scale: Numberish): FixedPointNumber {
    ...
    return new FixedPointNumber(
      integerPart.concat(roundedDecimalPart, zeroes),
      scale,
    );
  }
}
